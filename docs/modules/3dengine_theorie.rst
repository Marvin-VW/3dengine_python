...
- **Cube Space (Object Space)**:
  - Also known as object space or model space, this is the local coordinate system for each object. Every object in the scene has its own coordinate system, which simplifies the process of modeling and transforming the object independently of the world space.
